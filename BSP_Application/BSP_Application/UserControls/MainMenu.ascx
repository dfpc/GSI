...
<div id="MainMenu">
    <div class="list-group panel" style="color: white;">
        ...
        <div class="collapse" id="demo4">
            ...
            <a href="/FormPages/AdicionarOrganizacao.aspx" class="list-group-item active">Registar Organização</a>
            <a href="/Conteudos/ConsultarOrganizacao.aspx" class="list-group-item">Consultar Organização</a>
        ...
        <a href="#Matrizes1" class="list-group-item">Preencher Matriz da Arquitetura de Informação</a>
        <div class="collapse" id="Matrizes1">
            <a href="/Matrizes/Processo_ClasseDados.aspx" class="list-group-item">Processos/Classes de Dados</a>
            <a href="/Matrizes/Processo_Organizacao.aspx" class="list-group-item">Processos/Organização</a>
        </div>
