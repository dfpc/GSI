...
<div id="MainMenu">
    <div class="list-group panel" style="color: white;">
        ...
        <a href="/FormPages/AdicionarOrganizacao.aspx" class="list-group-item list-group-item-success" data-parent="#MainMenu">Registar Entidades da Organização</a>
        <a href="/Conteudos/ConsultarOrganizacao.aspx" class="list-group-item list-group-item-success" data-parent="#MainMenu">Consultar Entidades da Organização</a>
