...
<div id="MainMenu">
    <div class="list-group panel" style="color: white;">
        ...
        <a href="/Conteudo/ConsultarFuncoesEquipa.aspx" class="list-group-item list-group-item-success" data-parent="#MainMenu">Consultar Funções da Equipa de Direção do SI</a>
