        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <br />
                    ...
                    <div class="col-sm-2">
                        <asp:Button ID="btnOrder" cssClass="btn btn-block btn-success" Style="width: 20%" runat="server" onclick="btnOrder_Click" OnClientClick="if($('#tbxPosition').val()=='') return false;" Text="Alterar Posição"></asp:Button>
                    </div></div>
                <br />
                <center>
