...
=======
                        <label for="inputEmail3" class="col-sm-4 control-label"><b>Nome do Projeto</b></label>
>>>>>>> 1d3fea5fa2d1f1e117ba91279466de76e3c1682f

                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="inputNome" placeholder="Nome do Projeto" runat="server" required>
                        </div>
