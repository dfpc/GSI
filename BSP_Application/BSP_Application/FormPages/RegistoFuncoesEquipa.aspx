            ...
            <div class="col-lg-3">
                ...
                <div id="MainMenu">
                    <div class="list-group panel" style="color: white;">
                        ...
                        <a href="Registar Funções Equipa.html" class="list-group-item list-group-item-success active" data-parent="#MainMenu">Registar Funções da Equipa de Direção do SI</a>
                    </div>
                </div>
            </div>
            <!-- /.col-lg-3 -->
