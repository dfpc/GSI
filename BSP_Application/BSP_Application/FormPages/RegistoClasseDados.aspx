                ...
                <div id="MainMenu">
                    <div class="list-group panel" style="color:white;">
                        ...
                        <div class="collapse" id="demo4">
                            ...
                            <a href="Registar Classe de Dados.html" class="list-group-item active">Registar Classe de Dados</a>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="nome" class="form-control" id="inputNome" placeholder="Nome da Classe de Dados">
                                    </div>
                                </div>
                                <div class="form-group">
